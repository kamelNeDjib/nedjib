...
h2{
   ...
   <div class="col-lg-9 col-11 row container-fluid bg-light mx-0 content p-0">
           <h2>Add a Book</h2>
            <form class="box col-12 m-lg-2 m-md-2 m-sm-2 m-1 p-3" method="POST" enctype="multipart/form-data" action="/add_book_fun">
            {{ csrf_field() }}
                    ...
                    <div class="col-12 box-c">
                        ...
                        <div class="row col-12 mx-auto">
                            ...
                            <div class="box col-lg-3 col-md-4 col-6 my-2">
                                <input class="form-check-input inpt-radio" type="radio" name="categorie" value="{{$c->nomcategorie}}" id="flexCheckDefault-1" onfocus="changeValue()">
                                <label class="form-check-label" for="flexCheckDefault-1">{{ $c->nomcategorie }}</label>
                            </div>
                            @endforeach
                        </div>
